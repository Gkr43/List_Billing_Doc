		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#listbillingdoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"listbillingdoc-display": {
								"semanticObject": "listbillingdoc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=listbillingdoc",
									"url": sap.ui.require.toUrl("listbillingdoc")
								}
							}
						}
					}
